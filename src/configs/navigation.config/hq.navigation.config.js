        ...
        subMenu: [
            {
                ...
                subMenu: [
                  ...
                  },
                  {
                    ...
                    title: 'ToDo',
                    translateKey: 'nav.appsCustomers.toDo',
                    icon: '',
                    type: NAV_ITEM_TYPE_ITEM,
                    authority: [ADMIN, USER],
                    subMenu: [],
          ...
          },
          {
            ...
            subMenu: [
                ...
                },
                {
                  ...
                  title: 'Add Car',
                  translateKey: 'nav.appsFleet.productNew',
                  icon: '',
                  type: NAV_ITEM_TYPE_ITEM,
                  authority: [ADMIN, USER],
                  subMenu: [],
                },
                {
                    ...
                    path: `${APP_PREFIX_PATH}/fleet/product-edit/12`,
                    title: 'Edit Car',
                    translateKey: 'nav.appsFleet.productEdit',
                    icon: '',
                    type: NAV_ITEM_TYPE_ITEM,
                    authority: [ADMIN, USER],
                    subMenu: [],
