...
export default function CustomersUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setId_number(cleanValues.id_number);
    setId_expiry(cleanValues.id_expiry);
    setDrivers_licence(cleanValues.drivers_licence);
    setDrivers_licence_expiry(cleanValues.drivers_licence_expiry);
    setSalary_nett(cleanValues.salary_nett);
    setDate_reviewed(cleanValues.date_reviewed);
    setAddress_1(cleanValues.address_1);
    setAddress_2(cleanValues.address_2);
    setCity(cleanValues.city);
    setProvince(cleanValues.province);
    setPostal_code(cleanValues.postal_code);
    setId_file(cleanValues.id_file);
    setDrivers_licence_file(cleanValues.drivers_licence_file);
    setPoa_fi(cleanValues.poa_fi);
    setBank_statement_1_file(cleanValues.bank_statement_1_file);
    setBank_statement_2_file(cleanValues.bank_statement_2_file);
    setBank_statement_3_file(cleanValues.bank_statement_3_file);
    setSalary_slip_1_file(cleanValues.salary_slip_1_file);
    setSalary_slip_2_file(cleanValues.salary_slip_2_file);
    setSalary_slip_3_file(cleanValues.salary_slip_3_file);
    setErrors({});
  };
  const [customersRecord, setCustomersRecord] = React.useState(customers);
  React.useEffect(() => {
