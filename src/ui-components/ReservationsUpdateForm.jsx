...
export default function ReservationsUpdateForm(props) {
  ...
  const [reservationsRecord, setReservationsRecord] =
    React.useState(reservations);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(Reservations, idProp)
        : reservations;
      setReservationsRecord(record);
    };
    queryData();
  }, [idProp, reservations]);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            Reservations.copyOf(reservationsRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "ReservationsUpdateForm")}
      {...rest}
    >
      <TextField
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || reservations)}
